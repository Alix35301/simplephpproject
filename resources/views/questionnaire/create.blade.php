                ...
                <div class="card-body">
                    <form action="/questionnaires" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="titleHelp" class="form-text text-muted">Give a meaningful title for best result!.</small>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <small id="purposeHelp" class="form-text text-muted">Give a meaningful purpose for best result!.</small>
                            @error('purpose')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
